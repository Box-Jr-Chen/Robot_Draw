...
class Common:
    def __init__(self):
        ...
        self.get_ColorRealSize_start=[417, 233]
        ...
        self.PalCell_start =[13, 13]#(Cell_sx,Cell_sy)
        self.PalCell=[25, 40]#(width,height)
        self.PalCell_offset=[14, 12]#(width,height)
        ...
        self.pal_contrast = 50
        self.pal_brightness = 60
        
        self.main_color_contrast = 10
        self.main_color_brightness = 10
        
        #顏色HSB(Range)
        # TODO (錯誤)S 0-30 趨近於白灰
        self.Color_HSV =  {
         # 主色
         "yellow": {"name": "黃色", "range": [np.array([16, 50, 50]), np.array([35, 255, 255])]},
         "orange": {"name": "橙色", "range": [np.array([5, 50, 50]), np.array([15, 255, 255])]},
         "crimson": {"name": "深紅色", "range": [np.array([177, 50, 50]), np.array([180, 255, 255])]},
         "crimson_2": {"name": "深紅色", "range": [np.array([0, 50, 50]), np.array([5, 255, 255])]},
        ...
        #  "magenta": {"name": "洋紅色", "range": [np.array([155, 50, 50]), np.array([170, 255, 255])]},
         "magenta": {"name": "洋紅色", "range": [np.array([155, 50, 50]), np.array([177, 255, 255])]},
         "purpose": {"name": "紫色", "range": [np.array([135, 50, 50]), np.array([155, 255, 255])]},
         "blue-purpose": {"name": "藍紫色", "range": [np.array([118, 50, 50]), np.array([135, 255, 255])]},
         "blue": {"name": "藍色", "range": [np.array([113, 50, 50]), np.array([118, 255, 255])]},
         # 主色
         "cyan": {"name": "青色", "range": [np.array([93, 50, 50]), np.array([113, 255, 255])]},
         "green": {"name": "綠色", "range": [np.array([76, 50, 50]), np.array([93, 255, 255])]},
         "spring_green": {"name": "春綠色", "range": [np.array([56, 50, 50]), np.array([76, 255, 255])]},
         "chartreuse_green": {"name": "黃綠色", "range": [np.array([36, 50, 50]), np.array([56, 255, 255])]},
         }
        ...
        self.Systems_Colors = [
            ...
            ["黃色","橙色","深紅色","洋紅色"], #黃-深紅色
            ["洋紅色","紫色","藍紫色","藍色","青色"], #洋紅色-藍色
            ["青色","綠色","春綠色","黃綠色","黃色"] #青色-黃綠色
        ]
        ...
        # 筆的數量
        self.pen_times_draft_setting = 3
